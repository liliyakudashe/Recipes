...
@Service
public class IngredientServiceIpl implements IngredientService {

    private final Map<String, Ingredient> ingredients = new TreeMap<>();

    final private FileServiceIngredient fileServiceIngredient;

    public IngredientServiceIpl(FileServiceIngredient fileServiceIngredient) {
    ...
    private void saveToFile(){
        try {
            ...
            throw new IngredientNotFoundException("Файл не найден " + e);
        }
    }
